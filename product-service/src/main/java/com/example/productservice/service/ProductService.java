...
public class ProductService {
	...
	public ProductReponse getProductById(String id) {
		...
		ProductReponse pReponse = new ProductReponse(product.getId(), product.getName(), 
				product.getDesc(), product.getPrice(), product.getCategory(),product.getStock(),product.getImages());
		return pReponse;
	...
	public Product updateProduct(ProductReponse productReponse, String id) {
		Product p = new Product(id, productReponse.getName(), productReponse.getDesc(), productReponse.getPrice(), productReponse.getCategory(), productReponse.getStock(),productReponse.getImages());
